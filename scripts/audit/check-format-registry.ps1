...
$formatVersionEvidence = @(
    ...
    @{ Identity = 'candidate private-submission journal / NXPL / v2'; Source = 'crates/noxis-storage/src/private_submission_journal.rs'; Pattern = 'PRIVATE_SUBMISSION_JOURNAL_VERSION:\s*u16\s*=\s*2' }
