...
| **What is the executable proof work?** | [Private `H_ADDR` STARK relation](STARK_H_ADDR_RESEARCH_V0_1.md), [private `H_NOTE` STARK relation](STARK_H_NOTE_RESEARCH_V0_1.md), and [private ownership binding](STARK_NOTE_OWNERSHIP_BINDING_RESEARCH_V0_1.md) | The full-depth P24 Merkle experiment in `noxis-stark-experiment`; ownership and membership are not yet joined into a transfer proof. |
