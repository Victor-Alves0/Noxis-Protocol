...
| **What is the executable proof work?** | [Private `H_ADDR` STARK relation](STARK_H_ADDR_RESEARCH_V0_1.md), [private `H_NOTE` STARK relation](STARK_H_NOTE_RESEARCH_V0_1.md), and [private ownership-and-depth-32-membership binding](STARK_NOTE_OWNERSHIP_BINDING_RESEARCH_V0_1.md) | Full-depth ownership and membership are now one P24 research relation in `noxis-stark-experiment`; it is still not a state-anchor, nullifier-absence or transfer proof. |
