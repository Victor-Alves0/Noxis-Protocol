...
| **Can I run the hybrid recipient components?** | [Local hybrid wallet-crypto demo](WALLET_CRYPTO_LOCAL_DEMO_V0_1.md) | It demonstrates experimental key generation, strict `NXPA`/`NXRE` decoding, authenticated recipient encryption and hybrid identity signatures; it is not a wallet or private transfer. |
