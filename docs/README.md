...
| **How will backup and rollback be handled?** | [Backup and rollback policy candidate](WALLET_BACKUP_ROLLBACK_POLICY_CANDIDATE_V0_1.md) | It explains why an in-directory counter is insufficient, provides a public header anchor and defines the gates before secret backup/restore may exist. |
