...
O formato externo `NXTV` v1 para vetores de folha, nó, árvore vazia e caminho está definido em [`TREE_VECTOR_CORPUS_FRAMING_V0_1.md`](TREE_VECTOR_CORPUS_FRAMING_V0_1.md). O próximo passo é preenchê-lo com resultados reproduzidos de forma independente; até haver revisão desse conjunto, `NXTM` permanece intencionalmente vazio.
