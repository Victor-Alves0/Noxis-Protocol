...
`NXKA` externo. Construir a demonstração e os testes de backup/restauração em
processos separados, além de interrupções entre as duas publicações de destino.
