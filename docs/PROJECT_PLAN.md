...
**Corpus P24 inicial:** `NXTV v2` agora serializa esses sete vetores junto do
manifesto P24 completo e seu ID candidato. O perfil de cobertura `Initial` é
intencionalmente explícito: o parser rejeita perfil desconhecido e não permite
que esta amostra seja confundida com a cobertura completa da seleção. Ver
[`TREE_VECTOR_CORPUS_P24_V2.md`](TREE_VECTOR_CORPUS_P24_V2.md).
